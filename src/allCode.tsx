...
const PaymentForm: React.FC<PaymentFormProps> = ({ jobId, amount, bidId }) => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        {
          headers: {
            Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI0Njc1MzI1MS02Zjc3LTQxMzQtOTMzYS1lNGJmM2FmNjI5ZDUiLCJlbWFpbCI6InVzZXJAZ21haWwuY29tIiwicm9sZSI6IlVTRVIiLCJpYXQiOjE3Njg3MjQ5ODAsImV4cCI6MTc2OTMyOTc4MH0.KBUW0SrKzFGc3woiHBoABBqeVijjHgYZdR9PAdQmtiI`,
          },
        }
      );
...
function App() {
  ...
  const amount = 200;
  const bidId = "f43242aa-5009-44e9-9698-d7287e2cf61c"

  return (
    <Elements stripe={stripePromise}>
      <PaymentForm jobId={jobId} amount={amount} bidId={bidId} />
    </Elements>
  );
}
